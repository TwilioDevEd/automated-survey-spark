...
public class TwiMLMessageFactory extends AbstractMessageFactory {
  ...
  private TwiMLResponse nextTwiMLQuestion(Survey survey, TwiMLResponse twiml)
  ...
  private TwiMLResponse buildQuestionTwiML(Survey survey, Question question, TwiMLResponse twiml)
      throws TwiMLException, UnsupportedEncodingException {
